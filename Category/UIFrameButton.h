...
typedef NS_ENUM(NSInteger, UIButtonFrameSttyle)
{
   ...
   LeftImageWithRightTitleFrameStyle=0, //左边image 右边title
   LeftTitleWithRightImageFrameStyle,   //左边title 右边image
...
//使用
//button.frameStyle =TopTitleWithbuttomImageFrameStyle;
//button.beginDistance =0;
